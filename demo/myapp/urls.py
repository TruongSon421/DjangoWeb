...
urlpatterns = [
    ...
    path("record_all/<int:day>/<int:month>/<int:year>",views.record_all, name = "record_all"),
    path("record/<int:pk>", views.customer_record, name = "record"),
    path("delete_record/<int:pk>", views.delete_record, name = "delete_record"),
    path('add_record/<int:day>/<int:month>/<int:year>/', views.add_record, name='add_record'),
    ...
    path("pre_record_all/",views.pre_record_all, name ="pre_record_all"),
